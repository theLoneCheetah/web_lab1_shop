// Данные товаров
const products = [
    { id: 1, name: 'Рюкзак для ноутбука', price: 1000 },
    { id: 2, name: 'Портфель', price: 1500 },
    { id: 3, name: 'Кожаная сумка', price: 2000 },
    { id: 4, name: 'Рюкзак для мальчика', price: 1200 },
    { id: 5, name: 'Походный рюкзак', price: 1800 }
];
